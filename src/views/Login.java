	...
	public Login() {
		...
		txtUsuario.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				 if (txtUsuario.getText().equals("Digite su nombre de usuario")) {
					 txtUsuario.setText("");
		...
		txtUsuario.setText("Digite su nombre de usuario");
	...
	private void Login() {
	     ...
	     String Senha="admin";
	        ...
	        if(txtUsuario.getText().equals(Usuario) && senhaa.equals(Senha)){
	            ...
	            JOptionPane.showMessageDialog(this, "Usuario o password inválidos");
	        }
	} 
