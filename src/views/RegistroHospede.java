...
public class RegistroHospede extends JFrame {
	...
	public static Integer reservaId;
	...
	public RegistroHospede(Integer reservaId) {
		...
		JLabel lblNome = new JLabel("NOMBRE");
		...
		JLabel lblSobrenome = new JLabel("APELLIDO");
		...
		JLabel lblDataN = new JLabel("FECHA DE NACIMIENTO");
		...
		JLabel lblNacionalidade = new JLabel("NACIONALIDAD");
		...
		JLabel lblTelefone = new JLabel("TELEFONO");
		...
		btnsalvar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String fechaNacimiento = ((JTextField) txtDataN.getDateEditor().getUiComponent()).getText();
				//Integer telefonoInt = Integer.parseInt(txtTelefone.getText());
				Integer reservaIdInt = Integer.parseInt(txtNreserva.getText());
				Huesped huesped = new Huesped(txtNome.getText(), txtSobrenome.getText(), Date.valueOf(fechaNacimiento),
						txtNacionalidade.getSelectedItem().toString(), txtTelefone.getText() , reservaIdInt);
	...
	//Código que permite movimentar a janela pela tela seguindo a posição de "x" y "y"
	 private void headerMousePressed(java.awt.event.MouseEvent evt) {
		...
		private void limpiar() {
			...
			this.txtDataN.setCalendar(null);
			this.txtNacionalidade.setSelectedItem(0);
