...
//fin exit
	    ...
	    labelFecha.setText("Hoy es " + fecha); //estabelece a data na label
	    ...
	    String textoDescripcion = "<html><body>Sistema de reservas del hotel. Controla y Gestiona de forma obtimizada y fácil <br> el flujo de reservas y hospedajes del hotel   </body></html>";
	    ...
	    String textoDescricao1 = "<html><body> Esta herramenta te permitirá mantener un control completo y detallado de sus reservas y hospedajes, tendra acceso a herramientas especializadas para tarifas específicas como:</body></html>";
	    ...
	    JLabel labelDescricao_2 = new JLabel("- Registro de Reservas y Hospejes");
	    ...
	    JLabel labelDescricao_3 = new JLabel("- Edicion de Reservas e Hospejes existentes");
